...
class ArcApproximation:
    ...
    def generate_points(self, circle_center: Point, radius: float, start_point: Point, end_point: Point, points_per_circle: int = 36) -> list[Point]:
    ...
    def _find_intersection_with_element(
        ...
        if element._type == 'ellipse':
            ...
            a = ew / 2
            b = eh / 2
            intersection_points = CircleIntersection.with_ellipse(dx, dy, radius, a, b)
        elif element._type == 'rectangle':
            a = ew / 2
            b = eh / 2
            intersection_points = CircleIntersection.with_rectangle(dx, dy, radius, a, b)
        elif element._type == 'diamond':
            a = ew / 2
            b = eh / 2
            intersection_points = CircleIntersection.with_diamond(dx, dy, radius, a, b)
        else:
